...
title: Latent Space
type: concept
aliases: [latent space, interpolation, vector coordinates of the self]
tags: [concept, ai, neural-network, identity, recurring]
sources: ["[[diary]]", "[[implicit-distance]]", "[[ideas-sketchbook]]", "[[No More Human Art - Source Essay]]"]
created: 2026-06-22
updated: 2026-06-22
---
...
**Ernest's central technical-poetic metaphor: identity, art, and feeling as positions and trajectories inside a continuous interpolated space.**

## Summary
In the diary's most explicit statement (2024-09-17) he imagines a future where every
human trait — "politics, sports, language, employment, art, music, sexuality, religion,
nationality, and race" — is "labeled as vector coordinates in some sort of latent
space," and people can watch their own trajectories through it: "we'll no longer have
to worry about ever misunderstanding each other ever again." The same idea drives his
art: [[Implicit Distance]] is literally a walk through the latent space of a StyleGAN
trained on his life, and warping audio "interpolates between each audio sample."

## Key points
- Interpolation as both technique and worldview — distance is something you move *through*.
- His [[kits.ai Voice]] is the self reduced to a reusable point in such a space.
- The [[ideas-sketchbook]] is full of spatializations: "3d atlas," "spatial z index for
  the spatial web," "color as a temporal axis."

## Connections
- [[Ernest Strauhal]] / [[Family]] — read as autobiography: the "vector coordinates" of "nationality, language, race" are his own — Guangzhou and Santa Cruz, Cantonese and English, Chinatown and the Sacramento suburbs.
- [[Implicit Distance]] — the concept's purest realization in a work.
- [[kits.ai Voice]] — the self as a model others can sample.
- [[AI Slop]] — the dark side: being interpolated by systems outside your control.
- [[Alexander Scriabin]] / [[Wassily Kandinsky]] — older synesthetic dreams of mapping one sense onto another.
- [[Dead Architecture]] — generated duration as a path through already-computed transitions.
- [[Vocal Study 3]] — body and voice reorganized inside a model's space.

## Sources
- [[diary]]
- [[implicit-distance]]
- [[ideas-sketchbook]]
- [[No More Human Art - Source Essay]]
<!-- archive-links:start -->
## In the archive

*Images and books connected to this idea by filename (auto-generated).*

**Images (16).** [[Diagram of a Generative Adversarial Network (GAN) with Hello Kitty be131da7|Diagram of a Generative Adversarial Network (GAN) with Hello Kitty]] · [[Architecture Diagram Of Convolution And Deconvolution Neural Networks c2530418|Architecture Diagram Of Convolution And Deconvolution Neural Networks]] · [[Chart of Various Neural Network Architectures by Fjodor van Veen and Stefan Leijnen 2f8bdb66|Chart of Various Neural Network Architectures by Fjodor van Veen and Stefan Leijnen]] · [[Chart of Various Neural Network Architectures by Fjodor van Veen and Stefan Leijnen copy 4c49a34b|Chart of Various Neural Network Architectures by Fjodor van Veen and Stefan Leijnen copy]] · [[Comparison of Various Neural Network Architectures d04b646f|Comparison of Various Neural Network Architectures]] · [[Cortical Labs Glowing Neural Network Diagram by Cortical Labs a4598c95|Cortical Labs Glowing Neural Network Diagram by Cortical Labs]] · [[Diagrams Illustrating Complexity, Order, Disorder, and Generative Art Systems by Philip Galanter 58d325b0|Diagrams Illustrating Complexity, Order, Disorder, and Generative Art Systems by Philip Galanter]] · [[Fractal Boundaries of Neural Network Hyperparameters by Sohl Dickstein ba47d72b|Fractal Boundaries of Neural Network Hyperparameters by Sohl Dickstein]] · [[Illustration Abstract Generative Art With Colorful Pixels And Geometric Patterns 31deacd9|Illustration Abstract Generative Art With Colorful Pixels And Geometric Patterns]] · [[Illustration Abstract Generative Drawing Of Concentric Hexagonal Lines bc3e2f33|Illustration Abstract Generative Drawing Of Concentric Hexagonal Lines]] · [[Illustration Abstract Generative Line Art of Layered Arches and Columns 8d929ca5|Illustration Abstract Generative Line Art of Layered Arches and Columns]] · [[Illustration Abstract Generative Lines with Yellow Green Gradient and Orange Highlight 802c47b1|Illustration Abstract Generative Lines with Yellow Green Gradient and Orange Highlight]] · [[Illustration Surreal DeepDream Image of Dog like Creatures and Fish Patterns by Google DeepDream 92aa0708|Illustration Surreal DeepDream Image of Dog like Creatures and Fish Patterns by Google DeepDream]] · [[Illustration Surreal DeepDream Image of Multi Eyed Dog Like Creatures in Space by Google DeepDream 69ecd0d8|Illustration Surreal DeepDream Image of Multi Eyed Dog Like Creatures in Space by Google DeepDream]] · [[Timeline of Generative Adversarial Networks (GANs) Evolution be491b96|Timeline of Generative Adversarial Networks (GANs) Evolution]] · [[UMAP Embedding of LAION Aesthetics Captions 47648d14|UMAP Embedding of LAION Aesthetics Captions]]
