...
Source: [[media/strauh.al4/religious_texts/bible.html|source file]]

Concepts: [[HTML Source]], [[bible]], [[religious texts]], [[strauh.al Archive]]

## Compiled Page

strauh.al/religious_texts/bible

# [strauh.al](https://strauh.al)/[religious_texts](https://strauh.al/religious_texts)/bible
...
- explore books: click a book name on the left to highlight its key words.

- filter by theme: click a color in the compass to highlight connections of that theme. click again to reset.

- read verses: click any verse reference to read its full text.
